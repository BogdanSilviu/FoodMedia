...
namespace FoodMedia.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            {
                // No account yet — show confirmation page
                // Pass email to confirmation page
                ...
                return Page(); // Goes to ExternalLogin.cshtml -> which posts to OnPostConfirmationAsync
            }
        }
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            var user = new ApplicationUser
            {
                ...
                Email = Input.Email,
                DisplayName = null, // 🔸 Still null — profile must be filled
                Bio = "",
                ProfilePictureUrl = "",
